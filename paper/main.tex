...
On the EyePACS target (35{,}108 test images, five methods, two samplers, three
seeds) no method clears both bars. The domain-balanced sampler removes the
...
\todo{tables: foundation comparison, DG comparison, deployment cost --- emit
from export\_paper\_tables.py rather than transcribing}
